...
export default function Create({ auth }) {
    // Formdaki verileri ve hata durumlarını yöneteceğimiz Inertia Hook'u
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('vehicles.store')); // Verileri Laravel'deki store metoduna gönder
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Yeni Araç Ekle</h2>}
        >
